...
import UpdateAcademic from './UpdateGradelist';
import SeeAllAcademic from './SeeAllGradelist';

function GradelistCard({ index, data, setOriginalData }) {
  ...
  return (
    <div>
      {/* Document Group Card */}
      <div className={`${data.AdmissionOpen ? "bg-green-300" : "bg-red-100"} p-6 m-4 border rounded-lg shadow-md hover:shadow-lg transition-all duration-300`}>
        ...
        <span className="flex text-nowrap gap-2 font-semibold text-sky-900">Level Name:<h1 className="font-medium text-black">{(`${data?.LevelName}`)}</h1></span>
        <span className="flex text-nowrap gap-2 font-semibold text-sky-900">Area Name:<h1 className="font-medium text-black">{(`${data?.AreaName}`)}</h1></span>
        <span className="flex text-nowrap gap-2 font-semibold text-sky-900">Admission Open:<h1 className="font-medium text-black">{(`${data.AdmissionOpen ? 'Yes' : 'No'}`)}</h1></span>
          <span
